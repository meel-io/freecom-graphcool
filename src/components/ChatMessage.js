...
class ChatMessage extends Component {
            ...
            <div className="message-padding">
                <div className="flex flex-bottom">
                    <div className="message-container message-container-padding-right flex-right">
                        ...
                        {this.props.shouldRenderTimestamp && <p className="right opacity-4 padding-top-2">{ago}</p>}
                    </div>
                </div>
            </div>
        );
    ...
    render () {
        ...
        return <div className="fadeInLeft">{agent ? this._renderAgentMessage() : this._renderOwnMessage()}</div>;
    }
}
